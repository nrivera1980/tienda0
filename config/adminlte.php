...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Suscriptores',
            'route'       => 'admin.suscriptors.index',
            'icon'        => 'fas fa-fw fa-address-book',
            'active'      => ['admin/suscriptors*']
        ],
        ['header' => 'CONFIGURACION DEL SISTEMA'],
        [
            'text' => 'Tienda',
            'route'  => 'admin.tiendas.index',
            'icon' => 'fas fa-fw fa-store',
            'active' => ['admin/tiendas*']
        ],
        [
            'text' => 'Canal',
            'route'  => 'admin.canals.index',
            'icon' => 'fas fa-fw fa-tv',
            'active' => ['admin/canals*']
        ],
        [
            'text' => 'Baner',
            'route'  => 'admin.baners.index',
            'icon' => 'fas fa-fw fa-tv',
            'active' => ['admin/baners*']
        ],
        [
            'text' => 'Detaller baner',
            'route'  => 'admin.detallebaners.index',
            'icon' => 'fas fa-fw fa-tv',
            'active' => ['admin/detallebaners*']
        ],
        [
            'text' => 'Publicidad',
            'route'  => 'admin.publicidads.index',
            'icon' => 'fas fa-fw fa-tv',
            'active' => ['admin/publicidads*']
        ],
        [
            'text' => 'Enl. rapidas',
            'route'  => 'admin.rapidas.index',
            'icon' => 'fas fa-fw fa-tv',
            'active' => ['admin/rapidas*']
        ],
        [
            'text' => 'Concepto',
            'route'  => 'admin.conceptos.index',
            'icon' => 'fas fa-fw fa-shapes',
            'active' => ['admin/conceptos*']
        ],
        [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'route'  => 'admin.distritos.index',
                    'active' => ['admin/distritos*']
                ],
            ],
        ],
    ],
