...
@section('title_prefix', 'REDES SOCIALES: Editar | ')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::model($red, ['route' => ['admin.reds.update', $red], 'method' => 'put']) !!}
                ...
                <div class="form-group">
                    {!! form::submit('Actualizar red social', ['class' => 'btn btn-primary']) !!}
