...
@section('title_prefix', 'TIENDA: Editar | ')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::model($tienda, ['route' => ['admin.tiendas.update', $tienda], 'autocomplete' => 'off', 'files' => true, 'method' => 'put']) !!}
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            @if ($tienda->imagen)
                                <img id="picture" src="{{Storage::url($tienda->imagen)}}">
                            @else
