...
@section('title_prefix', 'ENLACES RAPIDOS: Crear | ')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.rapidas.store', 'autocomplete' => 'off', 'files' => true]) !!}
                ...
                <div class="form-group">
                    {!! form::submit('Crear enlace rapido', ['class' => 'btn btn-primary']) !!}
