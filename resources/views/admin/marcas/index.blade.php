...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-striped table-bordered" style="width:100%" id="marcas">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>NOMBRE</th>
                            ...
                            <td width="10px">
                                <div class="row justify-content-center">
                                    <div style="margin-right: 3px">
                                        <a class="btn btn-primary btn-sm" href="{{route('admin.marcas.edit', $item)}}" title="Editar"><i class="fa fa-edit"></i></a>
                                    </div>
                                    <div>
