@auth
    ...
    <x-app-layout>
        <div class="mx-auto">
            <section class="bg-cover bg-center" style="background-image: url({{asset('img/contactanos.jpg')}})">
                <div class="flex justify-around items-center container mx-auto">
                    <div class="w-full flex justify-start items-center h-60">
                        <div class="text-white text-lg lg:text-4xl font-bold"> Contáctanos</div>
                    </div>
                </div>
            </section>
        </div>
